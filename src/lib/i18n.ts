...
const ja: Dict = {
  ...
  copy_invite: '招待リンクをコピー', voice: '音声', voice_male: '男性', voice_female: '女性', speed: '読み上げ速度',
...
const fr: Dict = {
  ...
  import: 'Importer', copy_invite: "Copier le lien d'invitation", voice: 'Voix', voice_male: 'homme',
