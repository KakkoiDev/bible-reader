...
const ja: Dict = {
  ...
  play: '再生', copy_text: '節をコピー', copy_link: '節へのリンクをコピー', note: 'ノート', add_note: 'ノートを追加',
...
const fr: Dict = {
  ...
  play: 'Lire', copy_text: 'Copier le verset', copy_link: 'Copier le lien du verset', note: 'Note',
