...
const ja: Dict = {
  ...
  coverage_nt_only: 'この版は新約聖書のみを収録しています。', coverage_ot_only: 'この版は旧約聖書のみを収録しています。', coverage_chapter_absent: 'この章はこの版の底本に収録されていません。', gap_absent: 'この版にはありません', gap_versification: 'この版では番号の付け方が異なります',
...
const fr: Dict = {
  ...
  coverage_nt_only: 'Cette édition ne contient que le Nouveau Testament.', coverage_ot_only: 'Cette édition ne contient que l’Ancien Testament.', coverage_chapter_absent: 'Ce chapitre est absent de la source dont provient cette édition.', gap_absent: 'absent de cette édition', gap_versification: 'numérotation différente ici',
...
const zht: Dict = {
  ...
  coverage_nt_only: '此譯本僅收錄新約。', coverage_ot_only: '此譯本僅收錄舊約。', coverage_chapter_absent: '此章在本譯本的來源中缺失。', gap_absent: '此譯本沒有此節', gap_versification: '此處編號方式不同',
...
const zhs: Dict = {
  ...
  coverage_nt_only: '此译本仅收录新约。', coverage_ot_only: '此译本仅收录旧约。', coverage_chapter_absent: '此章在本译本的来源中缺失。', gap_absent: '此译本没有此节', gap_versification: '此处编号方式不同',
...
const pt: Dict = {
  ...
  coverage_nt_only: 'Esta edição contém apenas o Novo Testamento.', coverage_ot_only: 'Esta edição contém apenas o Antigo Testamento.', coverage_chapter_absent: 'Este capítulo não consta da fonte desta edição.', gap_absent: 'ausente nesta edição', gap_versification: 'numeração diferente aqui',
...
const es: Dict = {
  ...
  coverage_nt_only: 'Esta edición contiene solo el Nuevo Testamento.', coverage_ot_only: 'Esta edición contiene solo el Antiguo Testamento.', coverage_chapter_absent: 'Este capítulo no está en la fuente de esta edición.', gap_absent: 'ausente en esta edición', gap_versification: 'numeración distinta aquí',
...
const ar: Dict = {
  ...
  coverage_nt_only: 'تحتوي هذه الترجمة على العهد الجديد فقط.', coverage_ot_only: 'تحتوي هذه الترجمة على العهد القديم فقط.', coverage_chapter_absent: 'هذا الأصحاح غير موجود في المصدر الذي نُشرت منه هذه الترجمة.', gap_absent: 'غير موجود في هذه الترجمة', gap_versification: 'الترقيم مختلف هنا',
...
const tl: Dict = {
  ...
  coverage_nt_only: 'Bagong Tipan lamang ang nilalaman ng edisyong ito.', coverage_ot_only: 'Lumang Tipan lamang ang nilalaman ng edisyong ito.', coverage_chapter_absent: 'Wala ang kabanatang ito sa pinagmulan ng edisyong ito.', gap_absent: 'wala sa edisyong ito', gap_versification: 'iba ang pagnumero rito',
...
const el: Dict = {
  ...
  coverage_nt_only: 'Η έκδοση αυτή περιέχει μόνο την Καινή Διαθήκη.', coverage_ot_only: 'Η έκδοση αυτή περιέχει μόνο την Παλαιά Διαθήκη.', coverage_chapter_absent: 'Το κεφάλαιο αυτό λείπει από την πηγή αυτής της έκδοσης.', gap_absent: 'δεν υπάρχει σε αυτή την έκδοση', gap_versification: 'διαφορετική αρίθμηση εδώ',
...
const he: Dict = {
  ...
  coverage_nt_only: 'מהדורה זו כוללת את הברית החדשה בלבד.', coverage_ot_only: 'מהדורה זו כוללת את התנ״ך בלבד.', coverage_chapter_absent: 'פרק זה חסר במקור שממנו פורסמה מהדורה זו.', gap_absent: 'אינו קיים במהדורה זו', gap_versification: 'המספור כאן שונה',
